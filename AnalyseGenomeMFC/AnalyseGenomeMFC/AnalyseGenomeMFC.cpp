...
// AnalyseGenomeMFC.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CAnalyseGenomeMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CAnalyseGenomeMFCApp

CAnalyseGenomeMFCApp::CAnalyseGenomeMFCApp()
{
...
// Seul et unique objet CAnalyseGenomeMFCApp

CAnalyseGenomeMFCApp theApp;


// initialisation de CAnalyseGenomeMFCApp

BOOL CAnalyseGenomeMFCApp::InitInstance()
{
