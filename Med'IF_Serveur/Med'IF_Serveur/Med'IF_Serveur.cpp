...
// Med'IF_Serveur.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CMedIF_ServeurApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CMedIF_ServeurApp

CMedIF_ServeurApp::CMedIF_ServeurApp()
{
...
// Seul et unique objet CMedIF_ServeurApp

CMedIF_ServeurApp theApp;


// initialisation de CMedIF_ServeurApp

BOOL CMedIF_ServeurApp::InitInstance()
{
